    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7391), "Cactus", "Kaktus", "159c4d1f-d7e7-4ec4-b4e9-664530f1b20b_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7256) });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "Id", "CreatedDate", "NameEn", "NameTr", "UniqueId", "UpdatedDate" },
                values: new object[] { 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7403), "Succulent", "Sukulent", "2135abfe-6253-400b-a8d6-8552216b9976_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7393) });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "Id", "CreatedDate", "NameEn", "NameTr", "UniqueId", "UpdatedDate" },
                values: new object[] { 3, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7416), "Orchid", "Orkide", "c7b9c9a8-145d-4927-a545-7ed1469d5baa_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7404) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Make sure to keep your plant in a sunny place where it gets enough sunlight. Water the in-container Pachyphytum Oviferum only when you feel it soil dry to a depth of 4 inches. Avoid watering it when the soil still feels moist or else your fragile succulent will be damaged.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7911), "Badem Şekeri", 0, "Pachyphytum Oviferum", 50m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 5, "605ad9d5-48fa-48b2-b10c-2d11083a4fe7_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7911) },
                    { 2, "Being drought tolerant plants, Lola's (like almost all echeverias) like a deep watering and then allowing their soil dry out completely in between waterings. I advise you plant your Lola's in well-draining Succulent & Cactus blend soils, because they do not like their roots to remain in damp soil.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7934), "Beyaz Renk Muhteşem Form", 15, "Echeveria Lola", 75m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 2, "26e43c9f-91ef-43f1-b6d3-d2d4771c8328_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7935) },
                    { 3, "These succulents need bright light and well-draining soil. Place indoor plants near a southern or western window but not so close to the glass that they will sunburn. Outdoors, plant in pots around the patio or in the ground around pavers, border edges, and even in rockeries.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7951), "Güneşte Rengi Koyulaşır", 0, "Cremnosedum Little Gem", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 2, "4cb6b922-300c-47fe-8d27-7a602eaed43e_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7951) },
                    { 4, "Because Callisia is semi-succulent, she doesn't need too much water. Soak the soil thoroughly when watering, then make sure to let the top 5-10cm of soil dry out completely before watering again. If you are potting up, use a potting mix suitable for cacti/succulents. As with all plants, drainage is essential.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7960), "Pembe Yapraklı Telgraf Çiçeği", 25, "Callisia Repens (Pink Lady)", 100m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 3, "f02d455f-777f-40d0-9c23-229504502bb5_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7960) },
                    { 5, "Because Callisia is semi-succulent, she doesn't need too much water. Soak the soil thoroughly when watering, then make sure to let the top 5-10cm of soil dry out completely before watering again. If you are potting up, use a potting mix suitable for cacti/succulents. As with all plants, drainage is essential.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7968), "Zebra Bitkisi", 20, "Haworthia Fasciata Hibrid", 45m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 2, "de534a3c-8f15-4179-bb92-b787de1b75b9_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(7969) },
                    { 6, "The Yellow Tower Cactus, botanical name Parodia leninghausii, is a succulent plant found in the wild in Argentina. It is also known as the Leninghausii Cactus, the Lemon Cactus, and the Golden Ball Cactus. The Yellow Tower Cactus is a medium-sized columnar cactus that can reach a height of up to three feet tall, with a trunk that is about an inch thick. Each column sports around 30 ribs with soft white-gold spines emerging from the areolas. The spines are soft to the touch, unlike most cacti, making handling easy.", 1, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8027), "Sarı Çiçek Açan Kaktüs", 50, "Parodia Leninghausii", 78m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "7da52a62-be45-4c20-b8d8-f10455ac5ff3_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8028) },
                    { 7, "Paphiopedilum henryanum is a small species that originates from China and Vietnam. It was discovered relatively recently in 1987. Selective breeding has improved the form and color. Today’s flowers are larger, flatter and more intensely colored than the original specimens.This species is found growing on rocks in mixed forests. The summers are warm and rainy while the winters are cooler and drier. Winter temperatures can drop into the upper 40’s F. More details about its natural habitat can be found at the Internet Orchid Species Encyclopedia.\r\n\r\nWe find these easy to grow. They flower from late summer through early winter for us. You can find cultural tips on our care and feeding page.  We grow them along with our complex hybrids.", 3, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8038), "Kaplan Orkide", 10, "Phaphiopedilum Henryanum", 500m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "334b3235-5b4e-4570-a756-25ba8b371212_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8039) },
                    { 8, "While Paphiopedilum delenatii was for many years considered difficult to grow, years and generations of selection of good-growing parental stock have led to this species being quite easy. The plants seem to respond well to a variety of conditions, but will grow well with other mottled-leaved paphiopedilums, or with the brachypetalum or parvisepalum types. As always, water low in salts is a must. Plants should be kept evenly moist, approaching dryness, and provided with moderate light as for phalaenopsis. As with all paphiopedilums, Paph. delenatii does best with a fertilizing regime of 1/4-strength balanced plant food applied every week", 3, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8047), "Beyaz Orkide", 0, "Paphiopedilum Delenatii", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "018c76f0-c922-49c9-97cf-146a26d3e845_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8047) },
                    { 9, "Chlorophytum comosum “Bonnie” requires loose, neutral soil with good drainage. The growing medium also needs to provide good aeration for the roots to avoid fungal infections or root rot. A mix of coconut coir, houseplant compost, and sand or perlite is ideal.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8055), "Kurdele Çiçeği", 0, "Chlorophytum Comosum", 15m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "9ab79b56-7368-4b80-a87c-75ce60322252_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8056) },
                    { 10, "Houseplant care: Aichryson laxum is a fast growing plant, but tends to lose their lower leaves. In order to promote vegetative growth, the inflorescence should be cut off in time, otherwise this species will naturally grow as a biannual, dieing after flowering. Light: Provide bright light with some direct sunlight.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8065), "Aşk Ağacı", 0, "Aichryson Laxum", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "46ed2be7-780b-42ac-80dc-143d46ce3754_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8065) },
                    { 11, "The Pilea Peperomioides, also known as the Chinese Money Plant, is a fast-growing succulent-like houseplant that's great for beginning plant owners. The Pilea might seem like a succulent, with its fleshy leaves, but you shouldn't mistake it for one, as it has very different needs.In this plant care guide for the Pilea Peperomioides, we'll explore what this plant needs to thrive in your home. It's quite an easy plant to take care of, but it does have a few things you should be aware of.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8073), "Çin Para Ağacı", 0, "Pilea Peperomioides", 23m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "289e5b66-bc76-4b2e-8a8e-559ed9883d28_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8074) },
                    { 12, "Care Instructions To keep your watermelon peperomia happy and thriving there are a few simple rules to follow: Keep them in a bright room but out of direct sunlight. Do not overwater them, water them just enough to make the soil slightly damp.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8082), "Karpuz Sukulent", 0, "Peperomia Watermelon", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "4a1bf9d4-eb81-4ec9-893b-07d42d3eebb5_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8083) },
                    { 13, "Caring For Monanthes: Monanthes Polyphylla grows naturally on shaded cliffs and damp rocks.They do not require much water to thrive. 2) Monanthes requires well draining soil, they do not thrive in waterlogged soil. 3) They require a period of winter to rest, where watering is reduced to a bare minimum.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8091), "Nadir Tür", 0, "Monanthes Polyphylla ", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "550508af-e205-4f23-80c2-269fe1f57b6c_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8092) },
                    { 14, "he Echeveria Minima plant brings charm, beauty, and magic in its compact form, whether indoors or outdoors. Growing small Echeveria species like the Minima succulent plant is a great way to incorporate greenery into tight spaces with ease and elegance.Succulent collectors often find growing Echeveria Minima quite easy, as long as its roots remain relatively safe in potting soils with some gardening sand mixed in. It’s no wonder many growers propagate Echeveria Minima for its enthralling looks and ease of care!", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8102), "Nadir Tür Kırmizi Kenarlı", 0, "Echeveria Minima Red Edge", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "321b5e12-5123-46fa-881e-1658c4a13259_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8102) },
                    { 15, "The leaves of Echeveria Cubic Frost are different from other Echeveria species. It possesses thick, fleshy, and upturned leaves.The tubular-shaped leaves grow in the form of the rosette that offsets to form clusters. Apart from its peculiar shape and texture, its distinctiveness is enhanced due to its unique purple color.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8111), "Kıvrık Yapraklı", 0, "Echeveria Cubic Blue", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "9dfaa253-bf58-42b1-b0eb-4521f2666964_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8111) },
                    { 16, "Delosperma Echinatum can be quite beautiful when it is well-taken care of. This succulent type needs typical watering as the other succulents. The watering method is very important to keep your Pickle Plant healthy. It should not sit on the water, and an excess amount of water should be avoided.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8120), "Tombul Tüylü Yapraklı Sukulent", 0, "Delosperma Echinatum", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "e22f89fc-e833-47ea-9db3-dda3ed901526_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8121) },
                    { 17, "asin of Senecio herreianus generally needs to double every two years in soil. Peat soil, coarse sand mixed matrix are available, and usually it needs to be put in sunlight for careful maintenance. In the winter, control the temperature in 5 ~ 10 ℃, complete the anti-freezing measures are good.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8129), "String of Beads", 0, "Senecio Herreianus", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "f5268bd8-e46e-4eb6-aca6-72425d45ac25_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8129) },
                    { 18, "The succulent plant surprisingly is easy to look after. They can grow a bit during spring and summer. But they are carefree indoor plants from winter to spring. So we recommend placing your starfish flowers outdoors in summer and keeping them in a bright spot indoors in winter.", 1, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8137), "Leş Kaktüsü", 0, "Stapelia Variegata", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "c58359ac-64d4-4710-9cae-82fac2dee235_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8138) },
                    { 19, "Plants in the Sedum genus are super diverse, and are native to regions all over the world. Horticulturalists have bred them to create even more variietes that come in all manner of shapes and colors! Their succulent leaves help store water, and they are incredibly easy to propagate. Just gently pop off one of the leaves and with water and sunlight it will grow into a whole new plant.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8146), "Obesum", 0, "Sedum Lucidum", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "9c5bfeb4-be27-45b7-b384-ac4e5c93513d_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8146) },
                    { 20, "Echeveria Perle von Nürnberg can experience attacks from mealybugs. Inspect plants regularly and remove dead leaves left at the base of the plant. In addition to this, it is also important to never let this plant stand in water or else the chances of root rot and other fungal diseases will increase.", 2, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8154), "Güneşte Mor Tonları Çoğalır", 0, "Echeveria Perle Von Nurnberg", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "bcf3f6e5-382f-43a8-90a5-5d8175f06bd1_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8155) },
                    { 21, "It’s best for the Gymnocalycium mihanovichii (Moon Cactus) to grow in temperatures between 68° – 80° Fahrenheit (20 – 27°C), but it can handle temperatures as low as 35° Fahrenheit (2° C). The Moon Cacti are hardy plants but should never be exposed to temperatures below freezing, because this may kill the plant.", 1, new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8163), "Mor ve Bordo Renkli", 0, "Gymnocalycium Mihanovichii Purple Moon", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "773f1eb2-788c-42df-9849-24f3f621ae97_2023012009183940", new DateTime(2023, 1, 20, 9, 18, 39, 405, DateTimeKind.Local).AddTicks(8163) }
                });
