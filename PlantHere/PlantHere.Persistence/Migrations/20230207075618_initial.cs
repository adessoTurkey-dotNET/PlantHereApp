    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(6686), "Cactus", "Kaktus", "388e3cae-2ba9-4dc6-bfdf-ce9d0286572a_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(6500) });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "Id", "CreatedDate", "NameEn", "NameTr", "UniqueId", "UpdatedDate" },
                values: new object[] { 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(6704), "Succulent", "Sukulent", "0cae06d8-37d0-4b35-9ae3-6d585a387a54_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(6689) });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "Id", "CreatedDate", "NameEn", "NameTr", "UniqueId", "UpdatedDate" },
                values: new object[] { 3, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(6731), "Orchid", "Orkide", "393a2224-e023-4ca2-88f7-c49012496b82_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(6706) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Make sure to keep your plant in a sunny place where it gets enough sunlight. Water the in-container Pachyphytum Oviferum only when you feel it soil dry to a depth of 4 inches. Avoid watering it when the soil still feels moist or else your fragile succulent will be damaged.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7886), "Badem Şekeri", 0, "Pachyphytum Oviferum", 50m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 5, "426167c6-4efc-4f8c-a923-ab1c5743e48e_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7887) },
                    { 2, "Being drought tolerant plants, Lola's (like almost all echeverias) like a deep watering and then allowing their soil dry out completely in between waterings. I advise you plant your Lola's in well-draining Succulent & Cactus blend soils, because they do not like their roots to remain in damp soil.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7926), "Beyaz Renk Muhteşem Form", 15, "Echeveria Lola", 75m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 2, "2e42dca8-a44b-40be-84bd-9f7e623a9b7d_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7927) },
                    { 3, "These succulents need bright light and well-draining soil. Place indoor plants near a southern or western window but not so close to the glass that they will sunburn. Outdoors, plant in pots around the patio or in the ground around pavers, border edges, and even in rockeries.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7952), "Güneşte Rengi Koyulaşır", 0, "Cremnosedum Little Gem", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 2, "b3ba88e4-e2dd-4ef4-a9c5-5213d3b765ba_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7952) },
                    { 4, "Because Callisia is semi-succulent, she doesn't need too much water. Soak the soil thoroughly when watering, then make sure to let the top 5-10cm of soil dry out completely before watering again. If you are potting up, use a potting mix suitable for cacti/succulents. As with all plants, drainage is essential.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7965), "Pembe Yapraklı Telgraf Çiçeği", 25, "Callisia Repens (Pink Lady)", 100m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 3, "58a61a3c-ad70-4d18-bd84-90d04752b8ad_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7965) },
                    { 5, "Because Callisia is semi-succulent, she doesn't need too much water. Soak the soil thoroughly when watering, then make sure to let the top 5-10cm of soil dry out completely before watering again. If you are potting up, use a potting mix suitable for cacti/succulents. As with all plants, drainage is essential.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7976), "Zebra Bitkisi", 20, "Haworthia Fasciata Hibrid", 45m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 2, "9b7f9525-f5a2-4e1e-939b-0df3e36ff5a8_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7977) },
                    { 6, "The Yellow Tower Cactus, botanical name Parodia leninghausii, is a succulent plant found in the wild in Argentina. It is also known as the Leninghausii Cactus, the Lemon Cactus, and the Golden Ball Cactus. The Yellow Tower Cactus is a medium-sized columnar cactus that can reach a height of up to three feet tall, with a trunk that is about an inch thick. Each column sports around 30 ribs with soft white-gold spines emerging from the areolas. The spines are soft to the touch, unlike most cacti, making handling easy.", 1, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7988), "Sarı Çiçek Açan Kaktüs", 50, "Parodia Leninghausii", 78m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "88c10653-7d45-44d9-b4e7-207de16ba7f5_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(7989) },
                    { 7, "Paphiopedilum henryanum is a small species that originates from China and Vietnam. It was discovered relatively recently in 1987. Selective breeding has improved the form and color. Today’s flowers are larger, flatter and more intensely colored than the original specimens.This species is found growing on rocks in mixed forests. The summers are warm and rainy while the winters are cooler and drier. Winter temperatures can drop into the upper 40’s F. More details about its natural habitat can be found at the Internet Orchid Species Encyclopedia.\r\n\r\nWe find these easy to grow. They flower from late summer through early winter for us. You can find cultural tips on our care and feeding page.  We grow them along with our complex hybrids.", 3, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8044), "Kaplan Orkide", 10, "Phaphiopedilum Henryanum", 500m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "2fa5c407-ebb4-4964-b016-b938fe3e1b68_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8045) },
                    { 8, "While Paphiopedilum delenatii was for many years considered difficult to grow, years and generations of selection of good-growing parental stock have led to this species being quite easy. The plants seem to respond well to a variety of conditions, but will grow well with other mottled-leaved paphiopedilums, or with the brachypetalum or parvisepalum types. As always, water low in salts is a must. Plants should be kept evenly moist, approaching dryness, and provided with moderate light as for phalaenopsis. As with all paphiopedilums, Paph. delenatii does best with a fertilizing regime of 1/4-strength balanced plant food applied every week", 3, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8065), "Beyaz Orkide", 0, "Paphiopedilum Delenatii", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "04da0eed-35c6-4212-be2d-b41396c910b9_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8066) },
                    { 9, "Chlorophytum comosum “Bonnie” requires loose, neutral soil with good drainage. The growing medium also needs to provide good aeration for the roots to avoid fungal infections or root rot. A mix of coconut coir, houseplant compost, and sand or perlite is ideal.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8081), "Kurdele Çiçeği", 0, "Chlorophytum Comosum", 15m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "a7ff5935-1637-4b29-834b-a95911feed87_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8082) },
                    { 10, "Houseplant care: Aichryson laxum is a fast growing plant, but tends to lose their lower leaves. In order to promote vegetative growth, the inflorescence should be cut off in time, otherwise this species will naturally grow as a biannual, dieing after flowering. Light: Provide bright light with some direct sunlight.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8100), "Aşk Ağacı", 0, "Aichryson Laxum", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "49c5b9e7-a43a-4f95-b748-dc5199daaaef_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8101) },
                    { 11, "The Pilea Peperomioides, also known as the Chinese Money Plant, is a fast-growing succulent-like houseplant that's great for beginning plant owners. The Pilea might seem like a succulent, with its fleshy leaves, but you shouldn't mistake it for one, as it has very different needs.In this plant care guide for the Pilea Peperomioides, we'll explore what this plant needs to thrive in your home. It's quite an easy plant to take care of, but it does have a few things you should be aware of.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8118), "Çin Para Ağacı", 0, "Pilea Peperomioides", 23m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "f61cf875-42e5-4c72-9163-19e84e820397_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8119) },
                    { 12, "Care Instructions To keep your watermelon peperomia happy and thriving there are a few simple rules to follow: Keep them in a bright room but out of direct sunlight. Do not overwater them, water them just enough to make the soil slightly damp.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8135), "Karpuz Sukulent", 0, "Peperomia Watermelon", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "7cc01435-da03-4d3d-8308-b54f98f8b7a8_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8136) },
                    { 13, "Caring For Monanthes: Monanthes Polyphylla grows naturally on shaded cliffs and damp rocks.They do not require much water to thrive. 2) Monanthes requires well draining soil, they do not thrive in waterlogged soil. 3) They require a period of winter to rest, where watering is reduced to a bare minimum.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8152), "Nadir Tür", 0, "Monanthes Polyphylla ", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "82557cf7-0b7c-4f21-a5da-f45c4e1a37db_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8153) },
                    { 14, "he Echeveria Minima plant brings charm, beauty, and magic in its compact form, whether indoors or outdoors. Growing small Echeveria species like the Minima succulent plant is a great way to incorporate greenery into tight spaces with ease and elegance.Succulent collectors often find growing Echeveria Minima quite easy, as long as its roots remain relatively safe in potting soils with some gardening sand mixed in. It’s no wonder many growers propagate Echeveria Minima for its enthralling looks and ease of care!", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8170), "Nadir Tür Kırmizi Kenarlı", 0, "Echeveria Minima Red Edge", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "44d5f5a2-5c18-44e6-a3dc-3e24188974a4_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8171) },
                    { 15, "The leaves of Echeveria Cubic Frost are different from other Echeveria species. It possesses thick, fleshy, and upturned leaves.The tubular-shaped leaves grow in the form of the rosette that offsets to form clusters. Apart from its peculiar shape and texture, its distinctiveness is enhanced due to its unique purple color.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8188), "Kıvrık Yapraklı", 0, "Echeveria Cubic Blue", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "1855f582-ca17-480c-aa38-9006b26c5127_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8189) },
                    { 16, "Delosperma Echinatum can be quite beautiful when it is well-taken care of. This succulent type needs typical watering as the other succulents. The watering method is very important to keep your Pickle Plant healthy. It should not sit on the water, and an excess amount of water should be avoided.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8211), "Tombul Tüylü Yapraklı Sukulent", 0, "Delosperma Echinatum", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "583400a2-6c81-407f-acbc-99f4fc78feaa_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8212) },
                    { 17, "asin of Senecio herreianus generally needs to double every two years in soil. Peat soil, coarse sand mixed matrix are available, and usually it needs to be put in sunlight for careful maintenance. In the winter, control the temperature in 5 ~ 10 ℃, complete the anti-freezing measures are good.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8229), "String of Beads", 0, "Senecio Herreianus", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "07e94016-f978-4010-bb2e-2f1bacc069c7_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8230) },
                    { 18, "The succulent plant surprisingly is easy to look after. They can grow a bit during spring and summer. But they are carefree indoor plants from winter to spring. So we recommend placing your starfish flowers outdoors in summer and keeping them in a bright spot indoors in winter.", 1, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8248), "Leş Kaktüsü", 0, "Stapelia Variegata", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "9f440cd4-e648-42c6-9ea7-fbeb3a1cd2bc_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8249) },
                    { 19, "Plants in the Sedum genus are super diverse, and are native to regions all over the world. Horticulturalists have bred them to create even more variietes that come in all manner of shapes and colors! Their succulent leaves help store water, and they are incredibly easy to propagate. Just gently pop off one of the leaves and with water and sunlight it will grow into a whole new plant.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8268), "Obesum", 0, "Sedum Lucidum", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "c7f0e26e-7cc9-4ca4-9283-36d6a7284a37_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8269) },
                    { 20, "Echeveria Perle von Nürnberg can experience attacks from mealybugs. Inspect plants regularly and remove dead leaves left at the base of the plant. In addition to this, it is also important to never let this plant stand in water or else the chances of root rot and other fungal diseases will increase.", 2, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8287), "Güneşte Mor Tonları Çoğalır", 0, "Echeveria Perle Von Nurnberg", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "8b6429a0-f7e2-467f-87ca-a10ce4a24440_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8288) },
                    { 21, "It’s best for the Gymnocalycium mihanovichii (Moon Cactus) to grow in temperatures between 68° – 80° Fahrenheit (20 – 27°C), but it can handle temperatures as low as 35° Fahrenheit (2° C). The Moon Cacti are hardy plants but should never be exposed to temperatures below freezing, because this may kill the plant.", 1, new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8303), "Mor ve Bordo Renkli", 0, "Gymnocalycium Mihanovichii Purple Moon", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "3f5190f0-8e95-4328-992a-073363ea2892_2023020710561799", new DateTime(2023, 2, 7, 10, 56, 17, 992, DateTimeKind.Local).AddTicks(8303) }
                });
