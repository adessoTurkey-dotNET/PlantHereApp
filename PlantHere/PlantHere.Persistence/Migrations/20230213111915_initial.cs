    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7002), "Cactus", "Kaktus", "204aee48-6784-4a5c-88ba-b33b7d3e874a_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(6836) });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "Id", "CreatedDate", "NameEn", "NameTr", "UniqueId", "UpdatedDate" },
                values: new object[] { 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7013), "Succulent", "Sukulent", "e07124a1-35d5-40d6-87c3-75d4cc510a91_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7004) });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "Id", "CreatedDate", "NameEn", "NameTr", "UniqueId", "UpdatedDate" },
                values: new object[] { 3, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7027), "Orchid", "Orkide", "127b86af-2c1c-471a-a78b-ad9de768d383_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7014) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Make sure to keep your plant in a sunny place where it gets enough sunlight. Water the in-container Pachyphytum Oviferum only when you feel it soil dry to a depth of 4 inches. Avoid watering it when the soil still feels moist or else your fragile succulent will be damaged.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7538), "Badem Şekeri", 0, "Pachyphytum Oviferum", 50m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 5, "066ac962-8daf-4dff-bf49-811754d4fce4_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7538) },
                    { 2, "Being drought tolerant plants, Lola's (like almost all echeverias) like a deep watering and then allowing their soil dry out completely in between waterings. I advise you plant your Lola's in well-draining Succulent & Cactus blend soils, because they do not like their roots to remain in damp soil.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7558), "Beyaz Renk Muhteşem Form", 15, "Echeveria Lola", 75m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 2, "d5805f81-2dc4-4c0e-8e31-ecef5d8c43bb_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7558) },
                    { 3, "These succulents need bright light and well-draining soil. Place indoor plants near a southern or western window but not so close to the glass that they will sunburn. Outdoors, plant in pots around the patio or in the ground around pavers, border edges, and even in rockeries.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7577), "Güneşte Rengi Koyulaşır", 0, "Cremnosedum Little Gem", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 2, "cb1dc16e-7506-4611-a7b2-b29946ba8afd_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7577) },
                    { 4, "Because Callisia is semi-succulent, she doesn't need too much water. Soak the soil thoroughly when watering, then make sure to let the top 5-10cm of soil dry out completely before watering again. If you are potting up, use a potting mix suitable for cacti/succulents. As with all plants, drainage is essential.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7586), "Pembe Yapraklı Telgraf Çiçeği", 25, "Callisia Repens (Pink Lady)", 100m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 3, "d07b5b8b-dc42-4edb-82f1-5154305e2ba2_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7587) },
                    { 5, "Because Callisia is semi-succulent, she doesn't need too much water. Soak the soil thoroughly when watering, then make sure to let the top 5-10cm of soil dry out completely before watering again. If you are potting up, use a potting mix suitable for cacti/succulents. As with all plants, drainage is essential.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7595), "Zebra Bitkisi", 20, "Haworthia Fasciata Hibrid", 45m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 2, "e7a3a0e4-5bfb-4137-a0ab-23e2bc4f76fa_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7595) },
                    { 6, "The Yellow Tower Cactus, botanical name Parodia leninghausii, is a succulent plant found in the wild in Argentina. It is also known as the Leninghausii Cactus, the Lemon Cactus, and the Golden Ball Cactus. The Yellow Tower Cactus is a medium-sized columnar cactus that can reach a height of up to three feet tall, with a trunk that is about an inch thick. Each column sports around 30 ribs with soft white-gold spines emerging from the areolas. The spines are soft to the touch, unlike most cacti, making handling easy.", 1, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7607), "Sarı Çiçek Açan Kaktüs", 50, "Parodia Leninghausii", 78m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "6279f76f-71b5-4576-aa06-d1c187798459_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7608) },
                    { 7, "Paphiopedilum henryanum is a small species that originates from China and Vietnam. It was discovered relatively recently in 1987. Selective breeding has improved the form and color. Today’s flowers are larger, flatter and more intensely colored than the original specimens.This species is found growing on rocks in mixed forests. The summers are warm and rainy while the winters are cooler and drier. Winter temperatures can drop into the upper 40’s F. More details about its natural habitat can be found at the Internet Orchid Species Encyclopedia.\r\n\r\nWe find these easy to grow. They flower from late summer through early winter for us. You can find cultural tips on our care and feeding page.  We grow them along with our complex hybrids.", 3, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7616), "Kaplan Orkide", 10, "Phaphiopedilum Henryanum", 500m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "95a88438-8e44-43ae-9955-438a6f01b0dc_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7616) },
                    { 8, "While Paphiopedilum delenatii was for many years considered difficult to grow, years and generations of selection of good-growing parental stock have led to this species being quite easy. The plants seem to respond well to a variety of conditions, but will grow well with other mottled-leaved paphiopedilums, or with the brachypetalum or parvisepalum types. As always, water low in salts is a must. Plants should be kept evenly moist, approaching dryness, and provided with moderate light as for phalaenopsis. As with all paphiopedilums, Paph. delenatii does best with a fertilizing regime of 1/4-strength balanced plant food applied every week", 3, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7625), "Beyaz Orkide", 0, "Paphiopedilum Delenatii", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "e5a43ff6-8dcc-418b-95ef-85273887886e_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7625) },
                    { 9, "Chlorophytum comosum “Bonnie” requires loose, neutral soil with good drainage. The growing medium also needs to provide good aeration for the roots to avoid fungal infections or root rot. A mix of coconut coir, houseplant compost, and sand or perlite is ideal.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7633), "Kurdele Çiçeği", 0, "Chlorophytum Comosum", 15m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "67cd034f-64db-48d0-883f-ee802122d3a7_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7634) },
                    { 10, "Houseplant care: Aichryson laxum is a fast growing plant, but tends to lose their lower leaves. In order to promote vegetative growth, the inflorescence should be cut off in time, otherwise this species will naturally grow as a biannual, dieing after flowering. Light: Provide bright light with some direct sunlight.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7642), "Aşk Ağacı", 0, "Aichryson Laxum", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "482e9fe6-f803-4482-9b92-9fb721841208_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7642) },
                    { 11, "The Pilea Peperomioides, also known as the Chinese Money Plant, is a fast-growing succulent-like houseplant that's great for beginning plant owners. The Pilea might seem like a succulent, with its fleshy leaves, but you shouldn't mistake it for one, as it has very different needs.In this plant care guide for the Pilea Peperomioides, we'll explore what this plant needs to thrive in your home. It's quite an easy plant to take care of, but it does have a few things you should be aware of.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7677), "Çin Para Ağacı", 0, "Pilea Peperomioides", 23m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "67b92ee4-c7bf-4824-be34-2fca2c7e592f_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7678) },
                    { 12, "Care Instructions To keep your watermelon peperomia happy and thriving there are a few simple rules to follow: Keep them in a bright room but out of direct sunlight. Do not overwater them, water them just enough to make the soil slightly damp.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7687), "Karpuz Sukulent", 0, "Peperomia Watermelon", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "b645093d-0dc1-4787-94f1-0e51996ea073_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7687) },
                    { 13, "Caring For Monanthes: Monanthes Polyphylla grows naturally on shaded cliffs and damp rocks.They do not require much water to thrive. 2) Monanthes requires well draining soil, they do not thrive in waterlogged soil. 3) They require a period of winter to rest, where watering is reduced to a bare minimum.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7695), "Nadir Tür", 0, "Monanthes Polyphylla ", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "0f4605a8-5475-4d2b-bf3a-1f239b608b28_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7696) },
                    { 14, "he Echeveria Minima plant brings charm, beauty, and magic in its compact form, whether indoors or outdoors. Growing small Echeveria species like the Minima succulent plant is a great way to incorporate greenery into tight spaces with ease and elegance.Succulent collectors often find growing Echeveria Minima quite easy, as long as its roots remain relatively safe in potting soils with some gardening sand mixed in. It’s no wonder many growers propagate Echeveria Minima for its enthralling looks and ease of care!", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7706), "Nadir Tür Kırmizi Kenarlı", 0, "Echeveria Minima Red Edge", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "59c85b16-5e3f-4688-98d9-21a2e0905eed_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7706) },
                    { 15, "The leaves of Echeveria Cubic Frost are different from other Echeveria species. It possesses thick, fleshy, and upturned leaves.The tubular-shaped leaves grow in the form of the rosette that offsets to form clusters. Apart from its peculiar shape and texture, its distinctiveness is enhanced due to its unique purple color.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7714), "Kıvrık Yapraklı", 0, "Echeveria Cubic Blue", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "ee163fdf-c66a-457a-8195-f74397b9183e_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7715) },
                    { 16, "Delosperma Echinatum can be quite beautiful when it is well-taken care of. This succulent type needs typical watering as the other succulents. The watering method is very important to keep your Pickle Plant healthy. It should not sit on the water, and an excess amount of water should be avoided.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7722), "Tombul Tüylü Yapraklı Sukulent", 0, "Delosperma Echinatum", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "4bf6737e-4372-4c4e-a9c0-0da11dc44645_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7723) },
                    { 17, "asin of Senecio herreianus generally needs to double every two years in soil. Peat soil, coarse sand mixed matrix are available, and usually it needs to be put in sunlight for careful maintenance. In the winter, control the temperature in 5 ~ 10 ℃, complete the anti-freezing measures are good.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7731), "String of Beads", 0, "Senecio Herreianus", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "158600bd-a340-4819-ba32-4dc114f5b6f8_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7731) },
                    { 18, "The succulent plant surprisingly is easy to look after. They can grow a bit during spring and summer. But they are carefree indoor plants from winter to spring. So we recommend placing your starfish flowers outdoors in summer and keeping them in a bright spot indoors in winter.", 1, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7739), "Leş Kaktüsü", 0, "Stapelia Variegata", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "62f92413-c984-4e84-8cf5-dd5719107c3a_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7739) },
                    { 19, "Plants in the Sedum genus are super diverse, and are native to regions all over the world. Horticulturalists have bred them to create even more variietes that come in all manner of shapes and colors! Their succulent leaves help store water, and they are incredibly easy to propagate. Just gently pop off one of the leaves and with water and sunlight it will grow into a whole new plant.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7747), "Obesum", 0, "Sedum Lucidum", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "139a0085-1c07-440d-b196-914cb7cc4857_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7747) },
                    { 20, "Echeveria Perle von Nürnberg can experience attacks from mealybugs. Inspect plants regularly and remove dead leaves left at the base of the plant. In addition to this, it is also important to never let this plant stand in water or else the chances of root rot and other fungal diseases will increase.", 2, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7755), "Güneşte Mor Tonları Çoğalır", 0, "Echeveria Perle Von Nurnberg", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "24f6b009-0428-40b5-b1e3-1b3cb9db6234_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7755) },
                    { 21, "It’s best for the Gymnocalycium mihanovichii (Moon Cactus) to grow in temperatures between 68° – 80° Fahrenheit (20 – 27°C), but it can handle temperatures as low as 35° Fahrenheit (2° C). The Moon Cacti are hardy plants but should never be exposed to temperatures below freezing, because this may kill the plant.", 1, new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7763), "Mor ve Bordo Renkli", 0, "Gymnocalycium Mihanovichii Purple Moon", 150m, "d8a07002-0c3a-4add-874b-dd2b1e33aaae", 4, "61281f91-296e-4601-a7ad-e5dcbc89d5eb_2023021314191548", new DateTime(2023, 2, 13, 14, 19, 15, 480, DateTimeKind.Local).AddTicks(7764) }
                });
